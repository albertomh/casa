/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9d5305b466a361d292356494cd095d41)
// Runtime types generated with workerd@1.20260426.1 2026-04-22 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CasaDurableObject";
	}
	interface Env {
		HOME_ADDRESS: string;
		ALLOWED_COUNTRIES: string;
		CASA_DURABLE_OBJECT: DurableObjectNamespace<import("./src/index").CasaDurableObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HOME_ADDRESS" | "ALLOWED_COUNTRIES">> {}
}
